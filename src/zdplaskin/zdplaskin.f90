...
! config
!
  integer, parameter :: species_max = 7, species_electrons = 7, species_length = 8, reactions_max = 1, reactions_length = 19
...
300 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file <" &
    ...
    close(ifile_unit)
311 format(221x,7(1x,i9))
312 format(A1,1x,A19,1x,7(1x,A9))
313 format(i1,1x,A19,1x,7(1x,1pd9.2))
  endif
  return
