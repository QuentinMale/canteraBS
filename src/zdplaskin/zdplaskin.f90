...
! config
!
  integer, parameter :: species_max = 11, species_electrons = 11, species_length = 8, reactions_max = 4, reactions_length = 19
...
!
  double precision, parameter, private      :: bolsig_rtol = 1.00D-03, bolsig_rtol_half = 3.16D-02, &
                                               ...
                                               bolsig_eecol_frac_def = 1.00D-01
...
subroutine ZDPlasKin_reac_source_matrix(reac_rate_local,reac_source_local)
  ...
  reac_source_local(08,1) = + reac_rate_local(1) 
  reac_source_local(01,2) = - reac_rate_local(2) 
  reac_source_local(08,2) = + reac_rate_local(2) 
  reac_source_local(01,3) = - reac_rate_local(3) 
  reac_source_local(09,3) = + reac_rate_local(3) 
  reac_source_local(01,4) = - reac_rate_local(4) 
  reac_source_local(09,4) = + reac_rate_local(4) 
  return
...
subroutine ZDPlasKin_fex(neq,t,y,ydot)
  ...
  rrt(1) = rrt(1) * density(01) * density(11) 
  rrt(2) = rrt(2) * density(01) * density(11) 
...
subroutine ZDPlasKin_jex(neq,t,y,ml,mu,pd,nrpd)
  ...
  density(:) = y(1:species_max)
  call ZDPlasKin_reac_rates(t)
  pd(01,01) = pd(01,01) - rrt(1) * density(11) 
  pd(01,11) = pd(01,11) - rrt(1) * density(01) 
  pd(08,01) = pd(08,01) + rrt(1) * density(11) 
  pd(08,11) = pd(08,11) + rrt(1) * density(01) 
  pd(01,01) = pd(01,01) - rrt(2) * density(11) 
  pd(01,11) = pd(01,11) - rrt(2) * density(01) 
  pd(08,01) = pd(08,01) + rrt(2) * density(11) 
  pd(08,11) = pd(08,11) + rrt(2) * density(01) 
  pd(01,01) = pd(01,01) - rrt(3) * density(11) 
  pd(01,11) = pd(01,11) - rrt(3) * density(01) 
  pd(09,01) = pd(09,01) + rrt(3) * density(11) 
  pd(09,11) = pd(09,11) + rrt(3) * density(01) 
  pd(01,01) = pd(01,01) - rrt(4) * density(11) 
  pd(01,11) = pd(01,11) - rrt(4) * density(01) 
  pd(09,01) = pd(09,01) + rrt(4) * density(11) 
  pd(09,11) = pd(09,11) + rrt(4) * density(01) 
...
subroutine ZDPlasKin_reac_rates(Time)
  ...
  rrt(2) = -7.59D-11*EXP(-12466/TGAS)
  rrt(3) = bolsig_rates(bolsig_pointer(2))
  rrt(4) = -9.31D-11*EXP(-20579/TGAS)
