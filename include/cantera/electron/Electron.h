...
public:
     ...
     * @param cont_mode Flag of continue mode. This is useful to increase the
     *        the speed of multiple runs with a sight change to the parameters.
